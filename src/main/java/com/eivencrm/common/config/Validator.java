...
public class Validator {
	 ...
	 * 正则表达式：验证手机号
	 */
	public static final String REGEX_MOBILE = "^(13[0-9]|15[0-9]|17[5678]|18[0-9]|14[57])[0-9]{8}$";
	...
	public static final String REGEX_IP_ADDR =  "^(1\\d{2}|2[0-4]\\d|25[0-5]|[1-9]\\d|[1-9])\\."  
                ...
                +"(00?\\d|1\\d{2}|2[0-4]\\d|25[0-5]|[1-9]\\d|\\d)\\."  
                +"(00?\\d|1\\d{2}|2[0-4]\\d|25[0-5]|[1-9]\\d|\\d)$";// "(25[0-5]|2[0-4]\\d|[0-1]\\d{2}|[1-9]?\\d)";
	...
	public static void main(String[] args) {
		...
		System.out.println(Validator.isIPAddr("139.199.62.124"));
	}
}
